        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
          ...
          <div className="space-y-3">
            ...
            <details className="group">
              ...
              <form onSubmit={handleSignup} className="space-y-3 sm:space-y-4 mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-200">
                <div>
                  <label className="block text-xs sm:text-sm font-medium mb-2 text-gray-700">Name</label>
                  <input
                    type="text"
                    value={name}
                ...
                <div>
                  <label className="block text-xs sm:text-sm font-medium mb-2 text-gray-700">Confirm Password</label>
                  <input
                    type="password"
